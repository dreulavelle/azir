...
var stored = []struct {
	...
	{
		name:    "Conversations",
		detail:  "Chats with the assistant.",
	...
	},
	{
		...
		detail:  "Phone system support bundles.",
		counted: "snapshots",
	...
	{
		name:    "Ticket memory",
		detail:  "What past tickets were about.",
	...
	{
		name:    "Activity log",
		detail:  "Every tool call and admin action.",
		counted: "audit_log",
	...
	{
		name:    "Cached answers",
		detail:  "Recent results, reused instead of asking again.",
		counted: "tool_cache",
	...
	{
		name:    "Customers",
		detail:  "Your customers, and what each system calls them.",
		counted: "customers",
		tables:  []string{"customers", "customer_identities"},
	},
	{
		name:    "People",
		detail:  "Accounts and open sessions.",
		counted: "users",
		tables:  []string{"users", "sessions"},
	},
	{
		name:    "Connections",
		detail:  "Passwords, plugin settings and tool approvals.",
		counted: "credentials",

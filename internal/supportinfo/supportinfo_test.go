...
func TestFindsCallsWithNoAudio(t *testing.T) {
	log := "#Date: 2026/08/07\n" +
		"17:18:36.205|7ff6e96c46c0| Warn|MSEndPoint.cpp(1086): 5:[MS105000] C:3218.1: No RTP packets were received:remoteAddr=216.82.238.19:57046,extAddr=<none>,localAddr=63.210.128.28:9154\n" +
		"18:06:40.311|7ff6db7fe6c0| Warn|MSEndPoint.cpp(1086): 5:[MS105000] C:3275.1: No RTP packets were received:remoteAddr=216.82.238.19:36424,extAddr=<none>,localAddr=63.210.128.28:9260\n"
	...
	if !strings.Contains(found.Detail, "216.82.238.19") {
